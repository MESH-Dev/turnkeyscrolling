...
jQuery(document).ready(function($){
   var welcomeAnim = new TimelineMax(),
      ...
      welcomeGraphic = document.getElementById('welcomeGraphic'),
   ...
   if (welcomeGraphic) {
      welcomeAnim.set(welcomeGraphic, {css:{transform:"translateY(40px)", opacity:0}})
         .set(scrollLink, {css:{opacity:0}})
         .to(welcomeGraphic, 0.5, {css:{transform:"translateY(0px)", opacity:1}, ease: Power3.easeInOut, delay: 0.4})
         .to(scrollLink, 0.5, {css:{opacity:1}, ease: Power2.easeInOut});
   }
